...
public class CooldownMixin {
    ...
    private static int getEffectiveSpellCooldown(AbstractSpell spell, Player player, CastSource castSource, Operation<Float> original) {
        ...
        return (int) (spell.getSpellCooldown() * (2 - RebalanceHandler.rebalanceCooldownFormula(playerCooldownModifier)) * itemCoolDownModifer);
    }
}